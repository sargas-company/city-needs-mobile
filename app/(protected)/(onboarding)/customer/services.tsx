...
const CustomerServices = () => {
    ...
    const handleSubmit = async () => {
        try {
            await submitOnboarding({ action: 'CUSTOMER_CATEGORIES', payload: {} }).unwrap()
    ...
    return (
        <SafeAreaView className="flex-1 bg-white px-6">
            <View className="flex-1 items-center justify-center gap-4">
                <Text className="text-2xl font-bold text-black">Select services</Text>
                <Text className="text-base text-gray-700">Choose what you are interested in.</Text>
                <Pressable
